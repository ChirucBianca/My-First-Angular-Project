...
describe('Product List Component', () => {
  describe('Isolated Unit Tests',() => {
    it('should create 3 products on ngInit', () => {
    ...
    it('should find and update quantity onQuantityChange', () => {
      ...
      component.onQuantityChange({changeInQuantity: 1, product: getProduct(2)});
      component.onQuantityChange({changeInQuantity: 1, product: getProduct(1)});
      assertProducts(component.products, [1,3,0]);

      component.onQuantityChange({changeInQuantity: -3, product: getProduct(2)});
      assertProducts(component.products, [1,0,0]);
    });

    function assertProducts(products: {id: any; quantityInCart: any; }[], expectedQuantities: any[]){
...
describe('Angular tests', () => {
  let fixture: ComponentFixture<ProductListComponent>, component: ProductListComponent;
    ...
    it('should render three product list items', () => {
      ...
      assertProduct(productItems[0], 'Test1', 15, 0);
      assertProduct(productItems[1], 'Test2', 18, 0);
      assertProduct(productItems[2], 'Test3', 30, 0);
    });
    ...
    it('should handle increment item correctly from child product', () => {
      ...
      fixture.detectChanges();
      assertProduct(productItems[1], 'Test2', 18, 1);
    ...
    function assertProduct(element: { query: (arg0: Predicate<DebugElement>) => any; }, name: string, price: string | number, qty: string | number) {
